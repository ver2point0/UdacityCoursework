package lesson6dash2loops.largestcountries;// Bluej project: lesson6/largest_countries
...
public class LargestCountries
{
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        // Print the population and name of the country with largest population
