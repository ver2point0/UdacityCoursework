package lesson7dash2arrayslistsarrays.scores5;

/// / BlueJ project: lesson7/scores5

// Implement the removeLowest method more efficiently
...
public class HomeworkScores
{
    ...
    {
        // Find and return the index of the lowest score in scores.
        double low = lowScore();
        return find(low);
    }
