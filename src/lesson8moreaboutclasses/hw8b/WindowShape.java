package lesson8moreaboutclasses.hw8b;//Java Windows makes stain class windows of one particular shape. The windows are
...
public class WindowShape
{
    ...
    // Write an instance method to get the area of the shape
    public double area() {
        return WindowShape.area(this.w, this.h);
    }
    // Write a static method that takes the width and height of the rectangle
